...
if ( ! ${?TOOLS_FONT_PATH} ) then
  setenv TOOLS_FONT_PATH "`cd $geant4_envbindir/../share/Geant4/fonts > /dev/null ; pwd`"
else
  setenv TOOLS_FONT_PATH ${TOOLS_FONT_PATH}:"`cd $geant4_envbindir/../share/Geant4/fonts > /dev/null ; pwd`"
endif
