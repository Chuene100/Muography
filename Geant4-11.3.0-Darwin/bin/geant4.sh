...
if [ -z "${TOOLS_FONT_PATH-}" ] ; then
  export TOOLS_FONT_PATH="`cd $geant4_envbindir/../share/Geant4/fonts > /dev/null ; pwd`"
else
  export TOOLS_FONT_PATH=${TOOLS_FONT_PATH}:"`cd $geant4_envbindir/../share/Geant4/fonts > /dev/null ; pwd`"
fi
